...
class ModeloReporteInsumo {
  ...
  String? get nombreInsumo => nombreInsumoCache;

  /// Nombre del barbero que hizo el reporte.
  String? get nombreBarbero => nombreBarberoCache;

  /// Descripción / observaciones del reporte.
  String? get descripcion => descripcionCache ?? motivo;
  ...
  factory ModeloReporteInsumo.desdeJson(Map<String, dynamic> json) {
    return ModeloReporteInsumo(
      ...
      nombreBarberoCache: (json['nombre_barbero'] ?? json['barbero_nombre']) as String?,
