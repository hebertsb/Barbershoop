    ...
    try {
      ...
      try {
        ...
        final updateMap = <String, dynamic>{
          'nombre': json['nombre'],
          if (json['slogan'] != null) 'slogan': json['slogan'],
          if (json['url_logo'] != null) 'url_logo': json['url_logo'],
        };
        ...
        if (json['color_acento_hex'] != null) {
          await _cliente.from('configuraciones_barberia').upsert({
            'barberia_id': barberiaId,
            'clave': _claveColorAcento,
            'valor': {'hex': json['color_acento_hex']},
          }, onConflict: 'barberia_id,clave');
        }
      }
    } on SocketException {
      ...
      throw ExcepcionDesconocida(e.message.isNotEmpty ? e.message : 'Error al guardar la marca.');
    }
  }
}
